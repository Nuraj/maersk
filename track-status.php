...
<tbody><tr>
<td><img src="images/mainhead.jpg" width="900"></td>
</tr>
<tr>
 ...
 if (form.Consignment.value == "" )
		 {
			...
			return false;
              ...
              <tr bgcolor="EFEFEF">
                <td class="aalpha" valign="top"><div align="center">Enter the Container no </div></td>
              </tr>
              <tr bgcolor="EFEFEF">
            ...
            <form action="track-result.php" method="post" name="form" id="form" >
			      ...
			      <span class="gentxt">Ex: 4401 </span> </div></td>
                </tr>
              <tr bgcolor="EFEFEF">
                <td valign="top">&nbsp;</td>
              </tr>
              <tr bgcolor="EFEFEF">
                <td class="TrackNormalBlue" bgcolor="#FFFFFF" valign="top"> <br/></td>
              </tr>
